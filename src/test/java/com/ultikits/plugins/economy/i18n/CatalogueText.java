...
import com.ultikits.plugins.economy.i18n.UltiEconomyLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiEconomyLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiEconomyLanguageCatalogueTest.loadModuleCatalogues()) {
